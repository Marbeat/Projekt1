    ...
    <div class="row justify-content-center pb-lg-3">
        ...
        <div class="col-lg-6">
            <div class="text-white">
                ...
                Nasz formularz pozwoli Ci na sprecyzowanie szczegółów dotyczących zamówienia</p>
                <p>
                    <a href="{{ route('formularz') }}" class="btn btn-primary2 my-2"><span class="glyphicon glyphicon-file"></span> Przejdź do formularza</a>
                </p>
            </div>
            </div>
    </div>
